...
with tab1:
    ...
    #'MaxHR'
    x8 = st.number_input('Enter MaxHR')
    ...
    #'Oldpeak'
    x10 = st.number_input('Enter Oldpeak')
    ...
    st.header('Predicted Result: ' , str(int(pred[0])))
...
with tab2:
    ...
    fig = px.Figure(data=[
        ...
        px.Bar(name = 'Random Forest',
               x = x,
               y =  evaluations.loc['RandomForest']),
        px.Bar(name = 'KNeighbors',
               x = x,
               y = evaluations.loc['KNeighbors']),
